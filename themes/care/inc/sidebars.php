...
function mnky_sidebars() {
	...
	register_sidebar( array(
		...
		register_sidebar( array(
		'name' => __( 'Page Sidebar organizacion', 'care' ),
		'id' => 'organizacion-sidebar',
		'description' => __( 'Appears as default sidebar on pages', 'care' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name' => __( 'Page Sidebar Documentos', 'care' ),
		'id' => 'documentos-sidebar',
		'description' => __( 'Appears as default sidebar on pages', 'care' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		...
		register_sidebar( array(
		'name' => __( 'Page Footer Documentos', 'care' ),
		'id' => 'documentos-footer',
		'description' => __( 'Appears as default sidebar on pages', 'care' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
