...
<head>
	...
	<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri() . '/js/visor/modernizr.2.5.3.min.js' ?>"></script>
    <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri() . '/js/visor/hash.js' ?>"></script>
