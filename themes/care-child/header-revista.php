...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri() . '/revista/css/viewer.css' ?>">


<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="<?php echo get_stylesheet_directory_uri() . '/revista/locale/locale.properties' ?>">
<script src="<?php echo get_stylesheet_directory_uri() . '/revista/js/pdf.js' ?>"></script>


    <script src="<?php echo get_stylesheet_directory_uri() . '/revista/js/viewer.js' ?>"></script>

    <!-- $FB: additional files included -->
   
    <script src="<?php echo get_stylesheet_directory_uri() . '/revista/js/turn.min.js' ?>"></script>
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri() . '/revista/css/pdf-turn.css' ?>">
    <script src="<?php echo get_stylesheet_directory_uri() . '/revista/js/pdf-turn.js' ?>"></script>
</head>
	
<body <?php body_class(); ?>>
<!-- Carga informacion de muni informativo  -->

<!--fin de carga de menu -->
	<div id="wrapper">

		<?php 			
			// Check if full width header selected
			if ( ot_get_option('layout_style') != 'boxed' && ot_get_option('header_style') == 'full-width' ){ 
				$header_width = ' full-width';
			} else {
				$header_width = '';
			}
			
			// Generate header class
			$header_class = $header_width;	
		?>
	...
	<?php	} 
		...
		<header id="site-header" class="<?php echo $header_class; ?>" role="banner">
					...
					<nav id="site-navigation" role="navigation">
						...
						<?php if( class_exists( 'WooCommerce' ) && ot_get_option('cart_button') != 'off' ) : ?>
							<div class="header_cart_wrapper">
								...
								<a href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" title="<?php _e( 'View your shopping cart', 'care' ); ?>" class="header_cart_link" >
