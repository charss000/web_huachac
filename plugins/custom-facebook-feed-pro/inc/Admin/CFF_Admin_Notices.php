...
class CFF_Admin_Notices 
{
    ...
    public function get_renew_url() {
        ...
        $license_key = get_option( 'cff_license_key' ) ? get_option( 'cff_license_key' ) : null;
    ...
    public function cff_license_notices() {
        ...
        if( $cff_license_expires_date_arr[0] == '1' ) $cff_license_expired = false;
        ...
        echo '<div class="cff-admin-notices cff-license-expired-notice" id="cff-license-notice">';
        ...
        $output = '<span class="sb-notice-icon sb-error-icon">
            ...
            <div class="sb-notice-body">
                <div class="sb-notice-body-content">
                    <h3 class="sb-notice-title">Your Custom Facebook Feed Pro license key has expired!</h3>
                    <p>You are no longer receiving updates that protect you against upcoming Facebook changes</p>
                </div>
                <div class="license-action-btns">
                    <a href="'. $this->get_renew_url() .'" target="_blank" class="cff-license-btn cff-btn-blue cff-notice-btn">Renew License</a>
                    <button class="cff-license-btn cff-btn-grey cff-notice-btn" id="renew-modal-btn">Why Renew?</button>
                    <button class="cff-license-btn cff-btn-grey cff-notice-btn" id="recheck-license-key">
    ...
    public function get_modal_content() {
        $output = '<div class="cff-sb-modal license-details-modal">
            <div class="cff-modal-content">
                <button type="button" class="cancel-btn cff-btn" id="cff-sb-close-modal">
                    ...
                    <div class="sb-why-renew-list-parent">
                        <div class="sb-why-renew-list">
                            ...
                            <div class="sb-list-item">
                                <h4>Protected Against All Upcoming Facebook Platform Updates and API Changes</h4>
                                <p>Don\'t worry about your Facebook feeds breaking due to constant changes in the Facebook platform. Stay protected with access to continual plugin updates, giving you peace of mind that the software will always be up to date.</p>
                            </div>
                        </div>
                        <div class="sb-why-renew-list">
                            <div class="sb-icon">
                        ...
                        <div class="sb-why-renew-list">
                            ...
                            <div class="sb-list-item">
                                <h4>All Pro Facebook Feed Features</h4>
