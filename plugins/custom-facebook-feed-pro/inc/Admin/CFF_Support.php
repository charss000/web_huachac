...
class CFF_Support {
            ...
            'articles' => array(
                'gettingStarted' => array(
                    array(
                        ...
                        'link' => 'https://smashballoon.com/doc/installing-and-configuring-the-custom-facebook-feed-wordpress-plugin/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=Creating your first Facebook feed'
                    ),
                    array(
                        'title' => __( 'Displaying a Facebook Group feed', 'custom-facebook-feed' ),
                        'link' => 'https://smashballoon.com/doc/display-facebook-group-feed/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=Displaying a Facebook Group feed'
                    ),
                    array(
                        'title' => __( 'Displaying Facebook Events', 'custom-facebook-feed' ),
                        'link' => 'https://smashballoon.com/doc/displaying-facebook-events/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=Displaying Facebook Events'
                    ),
                ),
                'docs' => array(
                    array(
                        'title' => __( 'Facebook feed is not displaying', 'custom-facebook-feed' ),
                        'link' => 'https://smashballoon.com/doc/facebook-feed-doesnt-show-can-see-like-box-posts-gives/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=Facebook feed is not displaying'
                    ),
                    array(
                        'title' => __( 'Facebook posts missing or feed stopped updating', 'custom-facebook-feed' ),
                        'link' => 'https://smashballoon.com/doc/facebook-feed-appears-stopped-updating-working/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=Facebook posts missing or feed stopped updating'
                    ),
                    array(
                        'title' => __( 'How to resolve error messages', 'custom-facebook-feed' ),
                        'link' => 'https://smashballoon.com/doc/facebook-api-errors/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=How to resolve error messages'
                    ),
                ),
                'resources' => array(
                    array(
                        'title' => __( 'Add Facebook pages or groups to the same feed', 'custom-facebook-feed' ),
                        'link' => 'https://smashballoon.com/extensions/multifeed/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=Add Facebook pages or groups to the same feed'
                    ),
                    array(
                        'title' => __( 'Display your Facebook feed as a carousel', 'custom-facebook-feed' ),
                        'link' => 'https://smashballoon.com/extensions/carousel/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=Display your Facebook feed as a carousel'
                    ),
                    array(
                        'title' => __( 'Create a Facebook Reviews feed', 'custom-facebook-feed' ),
                        'link' => 'https://smashballoon.com/extensions/reviews/?utm_campaign=facebook-pro&utm_source=support&utm_medium=docs&utm_content=Create a Facebook Reviews feed'
                    ),
                ),
            )
        );
    ...
    public static function get_site_n_server_info() {
        ...
        $output .= 'Plugin Version:' . self::get_whitespace( 11 ) . WPW_SL_ITEM_NAME . "</br>";
    ...
    public static function get_global_settings_info() {
        ...
        if ( wp_next_scheduled( 'cff_cache_cron' ) ) {
			//Get the timezone
			$cff_orig_timezone = date_default_timezone_get();
			if ( isset( $cff_options[ 'cff_timezone' ] ) ) {
				date_default_timezone_set( $cff_options[ 'cff_timezone' ] );
			}
			...
			$cff_next_cron_event = wp_next_scheduled( 'cff_cache_cron' );
			$output .= 'Next check at ' . date('g:i a', $cff_next_cron_event) . ' (' . $schedule . ')';
    ...
    public static function get_action_logs_info() {
        ...
        $actions = \cff_main_pro()->cff_error_reporter->get_action_log();
        if ( ! empty( $actions ) ) :
