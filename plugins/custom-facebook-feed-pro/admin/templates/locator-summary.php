 ...
 *
 * @version X.X.X Custom Feeds for Facebook Pro by Smash Balloon
 *
 */

use CustomFacebookFeed\CFF_FB_Settings;
use CustomFacebookFeed\CFF_Settings_Pro;
	...
	<div class="cff-single-location">
		...
		<table class="widefat striped">
			...
			<?php
                ...
                $display_terms = CFF_Settings_Pro::feed_type_and_terms_display( $connected_accounts, $result, $database_settings );
